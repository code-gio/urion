<script lang="ts">
	...
	function handleViewDetails(submission: BacklinkSubmission) {
		goto(`/w/${workspace?.slug}/p/${project?.slug}/t/backlink-directory/submissions/${submission.id}`);
	}
...
<div class="container mx-auto py-8 px-4">
	<div class="mb-8 flex items-center justify-between">
		...
		<Button onclick={() => goto(`/w/${workspace?.slug}/p/${project?.slug}/t/backlink-directory`)}>
			+ Add Site
		</Button>
	</div>
